...
<link href="${pageContext.request.contextPath}/tiles/t11.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/tiles/base.css" rel="stylesheet" type="text/css">
</head>
<body>
 <div class="container">
        ...
        <div class="nav-bar">
            <span class="">方向：</span>
            <a class="nav-bar-a a-selected" href="${pageContext.request.contextPath}/tiles/list">全部</a>
            <a class="nav-bar-a" href="${pageContext.request.contextPath}/tiles/list/1">前端开发</a>
            <a class="nav-bar-a" href="${pageContext.request.contextPath}/tiles/list/2">后端开发</a>
            <a class="nav-bar-a" href="${pageContext.request.contextPath}/tiles/list/3">移动开发</a>
            <a class="nav-bar-a" href="${pageContext.request.contextPath}/tiles/list/4">整站开发</a>
            <a class="nav-bar-a" href="${pageContext.request.contextPath}/tiles/list/5">运营维护</a>
        </div>
 		<div class="caption">
            <h4>${type} </h4>
        </div>
