...
<div class="container  hidden-xs">
            <div class="row header-top">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right">
                    <div>
                       <a href="#" target="_blank"> <img alt=""  src="${pageContext.request.contextPath}/tiles/images/54537.png"></a>
                        <a href="#" target="_blank"><img alt=""  src="${pageContext.request.contextPath}/tiles/images/45678678.png"></a>
                        <a href="#" target="_blank"> <img alt=""  src="${pageContext.request.contextPath}/tiles/images/54375483543.png"></a>
                    </div>
                </div>
            </div>
	</div>
			...
			<div class="container">
					<div class="navbar-header">
						<a href="#" class="navbar-brand">
                       		 <img src="${pageContext.request.contextPath}/tiles/images/logo.png" alt="Brand" class="img-responsive">
                    	</a>
                    ...
                    <ul class="nav navbar-nav navbar-right text-center list-inline">
                        <li><a href="${pageContext.request.contextPath}/tiles/index">首页</a></li>
                        <li><a href="${pageContext.request.contextPath}/tiles/list">职业</a></li>
                        <li><a href="">推荐</a></li>
                        <li><a href="">关于</a></li>
                    </ul>
                </div>
